...
internal sealed class AzureSchedulerResources
{
    public AzureSchedulerResources(
        ...
        ILoggerFactory loggerFactory)
    {
        Table = new AzurePlatformTable(
            clientFactory,
            options,
            loggerFactory.CreateLogger<AzureSchedulerResources>(),
            nameResolver.GetSchedulerTableName());
        ...
        SignalQueue = new AzurePlatformQueue(
            ...
            nameResolver.GetSchedulerSignalQueueName());
