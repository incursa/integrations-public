...
internal sealed class AzureOutboxResources
{
    public AzureOutboxResources(
        ...
        ILoggerFactory loggerFactory)
    {
        Table = new AzurePlatformTable(
            clientFactory,
            options,
            loggerFactory.CreateLogger<AzureOutboxResources>(),
            nameResolver.GetOutboxTableName());
        ...
        SignalQueue = new AzurePlatformQueue(
            ...
            nameResolver.GetOutboxSignalQueueName());
